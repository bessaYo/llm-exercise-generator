...
class BloomClassifier:
    """
    Classifies a given learning objective into a Bloom's Taxonomy level 
    based on the verb used in the sentence.
    """
    
    bloom_levels = {
        "create": ["design", "formulate", "build", "invent", "create", "compose", "generate", "derive", "modify", "develop"],
        "evaluate": ["choose", "support", "relate", "determine", "defend", "judge", "grade", "compare", "contrast", "argue", "justify", "convince", "select", "evaluate"],
        "analyze": ["classify", "categorize", "analyze", "diagram", "illustrate", "criticize", "simplify", "associate", "differentiate"],
        "apply": ["calculate", "predict", "apply", "solve", "illustrate", "use", "demonstrate", "determine", "model", "perform", "present"],
        "understand": ["describe", "explain", "paraphrase", "restate", "summarize", "contrast", "interpret", "discuss"],
    ...
    def classify(self, learning_objective):
        ...
        Args:
            learning_objective (str): The learning objective to classify.

        Returns:
            list: A list of matched Bloom's Taxonomy levels.
        """
